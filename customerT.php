...
if (isset($_POST["sub"])) {
  ...
  if (!empty($first) && !empty($last) && !empty($age) && !empty($phone) && !empty($email) && !empty($gender)) {
    $createQuery = "INSERT INTO `c9`.`customer` (
      `firstname`, `lastname`, `age`, `gender`, `phonenumber`, `email`, `address`) VALUES ('$first', '$last', '$age', '$gender', '$phone', '$email', '$address');";
...
<h8>Add New Customer Profile</h8>
<div>
